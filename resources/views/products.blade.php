    ...
    <!-- <style>
        ...
        @layer theme {
            ...
            :host {
                ...
                --color-red-50: oklch(96.2% .018 272.314);
                --color-red-100: oklch(93% .034 272.788);
                --color-red-200: oklch(87% .065 274.039);
                --color-red-300: oklch(78.5% .115 274.713);
                --color-red-400: oklch(67.3% .182 276.935);
                --color-red-500: oklch(58.5% .233 277.117);
                --color-red-600: oklch(51.1% .262 276.966);
                --color-red-700: oklch(45.7% .24 277.023);
                --color-red-800: oklch(39.8% .195 277.366);
                --color-red-900: oklch(35.9% .144 278.697);
                --color-red-950: oklch(25.7% .09 281.288);
...
<body>
    <div class="relative max-w-7xl mx-auto">
                    ...
                    <div class="max-w-xl hidden lg:block">
                        <form class="mx-4">
                            <div class="flex shadow-xs rounded-base">
                                <select
                                    class="w-48 bg-white px-4 text-black rounded-tl-full rounded-bl-full border-none focus:ring-0">
                                ...
                                <input type="text"
                                    class="w-96 bg-white px-4 rounded-tr-full border-none rounded-br-full text-black pr-6 focus:ring-0 focus:outline-hidden"
                                    placeholder="Buscar...">
                            </div>
                        </form>
                    </div>
        ...
        <main>
            <!-- Breadcrumbs -->
            <div class="flex items-center bg-gray-700 h-12 text-white">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center space-x-1.5">
                                ...
                                <a href="#"
                                    class="inline-flex items-center text-sm font-medium text-body hover:text-fg-brand">Tienda</a>
                            </div>
                        </li>
                    </ol>
                </nav>
                            ...
                            <ul class="flex flex-col gap-3">
                                <li class="flex items-center gap-2">
                                    <input type="checkbox" id="checkbox-1" name="checkbox-1" value="1"
                                        class="size-4 border border-black rounded-sm cursor-pointer">
                                        ...
                                        <form class="">
                                            <div class="relative flex items-center">
                                                ...
                                                <input type="text" id="quantity-input" data-input-counter
                                                    ...
                                                    class="border-x-0 h-10 w-10 text-center py-2.5" placeholder="1"
                                                    required value="1" />
        ...
        <footer>
            <!-- Footer - Hero -->
            <div class="bg-red-600 px-7 py-5 flex flex-col justify-start">
                <div class="flex flex-col lg:flex-row lg:gap-10 lg:items-center">
                    <div class="w-1/3 my-2 lg:w-3/4">
                        <img src="{{ asset('img/logo_lca.jpg') }}" class="aspect-auto" alt="Web LCA Logo" />
                    </div>
                    <div class="mt-3">
                        <p class="text-sm leading-tight text-justify text-white lg:leading-normal lg:text-[1.1rem]">En
                ...
                <div class="my-6 flex justify-center">
                    <ul class="flex text-xl gap-3 lg:gap-10 lg:mt-4 lg:text-3xl">
                        <li
                            class="flex justify-center items-center bg-gray-600 w-10 h-10 rounded-full group hover:bg-white lg:w-16 lg:h-16">
                            <a href="#"><i class="fa-brands fa-facebook-f text-white group-hover:text-red-600"></i></a>
                        </li>
                        <li
                            class="flex justify-center items-center bg-gray-600 w-10 h-10 rounded-full group hover:bg-white lg:w-16 lg:h-16">
                            <a href="#"><i class="fa-brands fa-instagram text-white group-hover:text-red-600"></i></a>
                        </li>
                        <li
                            class="flex justify-center items-center bg-gray-600 w-10 h-10 rounded-full group hover:bg-white lg:w-16 lg:h-16">
                            <a href="#"><i class="fa-brands fa-tiktok text-white group-hover:text-red-600"></i></a>
                        </li>
                        <li
                            class="flex justify-center items-center bg-gray-600 w-10 h-10 rounded-full group hover:bg-white lg:w-16 lg:h-16">
                            <a href="#"><i class="fa-brands fa-youtube text-white group-hover:text-red-600"></i></a>
                        </li>
                        <li
                            class="flex justify-center items-center bg-gray-600 w-10 h-10 rounded-full group hover:bg-white lg:w-16 lg:h-16">
                            <a href="#"><i class="fa-brands fa-whatsapp text-white group-hover:text-red-600"></i></a>
                        </li>
                    </ul>
                </div>
                <div class="pb-8">
                    <h2 class="my-2 font-extrabold text-white lg:text-xl">Contacto</h2>
                    <div class="flex flex-col gap-1 text-white">
                        <p class="text-lg"><i class="fa-solid fa-house-user mx-3"></i>Jr. Maturín y Jr. Maracaibo,
                            Ayacucho</p>
                        <p class="text-lg"><i class="fa-regular fa-calendar-days mx-3"></i>Lunes a Domingos de 7:00 a
                            18:00</p>
                        <p class="text-lg"><i class="fa-solid fa-handshake mx-3"></i>Ventas 01: 994366171</p>
                        <p class="text-lg"><i class="fa-solid fa-handshake mx-3"></i>Ventas 02: </p>
                        <p class="text-lg"><i
                                class="fa-solid fa-envelope-circle-check mx-3"></i>ventas@lacasadelautomovil.com</p>
                    </div>
                </div>
                <div class="border-t border-white pt-6 mb-4">
