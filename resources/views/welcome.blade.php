    ...
    <div class="relative max-w-7xl mx-auto">
        <header class="sticky top-0 z-50">
            ...
            <nav>
                ...
                <div id="navbar-main" class="hidden fixed start-0 top-14 sm:top-16 bg-white shadow-md h-screen w-96 z-50">
        ...
        <main>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide bg-gray-200 rounded-2xl shadow-lg shadow-black-400 ">
                                <div class="h-[30rem] px-4 max-w-4xl lg:mx-auto">
                                    ...
                                    <div class="lg:flex lg:h-[68%] lg:gap-10 h-[30rem]">
                                        <div class="flex items-center justify-center h-2/4 w-full sm:mb-4 lg:h-full">
                                            <img src="{{ asset('img/repuesto_2.jpg') }}"
                                                class="h-full object-cover lg:w-full" />
                                        </div>
                                        <div class="flex lg:flex-col lg:justify-normal justify-between lg:w-1/3">
                                            <div class="mb-8 flex flex-col gap-1 text-sm sm:text-base">
                            ...
                            <div class="swiper-slide bg-gray-200 rounded-2xl shadow-lg shadow-black-400 ">
                                <div class="h-[30rem] px-4 max-w-4xl lg:mx-auto">
                                    ...
                                    <div class="lg:flex lg:h-[68%] lg:gap-10 h-[30rem]">
                                        <div class="flex items-center justify-center h-2/4 w-full sm:mb-4 lg:h-full">
                                            <img src="{{ asset('img/repuesto_3.jpg') }}"
                                                class="h-full object-cover lg:w-full" />
                                        </div>
                                        <div class="flex lg:flex-col lg:justify-normal justify-between lg:w-1/3">
                                            <div class="mb-8 flex flex-col gap-1 text-sm sm:text-base">
                            ...
                            <div class="swiper-slide bg-gray-200 rounded-2xl shadow-lg shadow-black-400 ">
                                <div class="h-[30rem] px-4 max-w-4xl lg:mx-auto">
                                    ...
                                    <div class="lg:flex lg:h-[68%] lg:gap-10 h-[30rem]">
                                        <div class="flex items-center justify-center h-2/4 w-full sm:mb-4 lg:h-full">
                                            <img src="{{ asset('img/repuesto_4.jpg') }}"
                                                class="h-full object-cover lg:w-full" />
                                        </div>
                                        <div class="flex lg:flex-col lg:justify-normal justify-between lg:w-1/3">
                                            <div class="mb-8 flex flex-col gap-1 text-sm sm:text-base">
                            ...
                            <div class="swiper-slide bg-gray-200 rounded-2xl shadow-lg shadow-black-400 ">
                                <div class="h-[30rem] px-4 max-w-4xl lg:mx-auto">
                                    ...
                                    <div class="lg:flex lg:h-[68%] lg:gap-10 h-[30rem]">
                                        <div class="flex items-center justify-center h-2/4 w-full sm:mb-4 lg:h-full">
                                            <img src="{{ asset('img/repuesto_5.jpg') }}"
                                                class="h-full object-cover lg:w-full" />
                                        </div>
                                        <div class="flex lg:flex-col lg:justify-normal justify-between lg:w-1/3">
                                            <div class="mb-8 flex flex-col gap-1 text-sm sm:text-base">
                            ...
                            <div class="swiper-slide bg-gray-200 rounded-2xl shadow-lg shadow-black-400 ">
                                <div class="h-[30rem] px-4 max-w-4xl lg:mx-auto">
                                    ...
                                    <div class="lg:flex lg:h-[68%] lg:gap-10 h-[30rem]">
                                        <div class="flex items-center justify-center h-2/4 w-full sm:mb-4 lg:h-full">
                                            <img src="{{ asset('img/logo_lca.jpg') }}"
                                                class="h-full object-cover lg:w-full" />
                                        </div>
                                        <div class="flex lg:flex-col lg:justify-normal justify-between lg:w-1/3">
                                            <div class="mb-8 flex flex-col gap-1 text-sm sm:text-base">
            ...
            <div class="flex flex-col h-80 items-center justify-center w-full bg-gray-200 sm:h-[30rem] -mt-8">
                <div>
        ...
        <footer class="-mt-8">
            ...
            <div class="bg-red-600 px-7 py-5 flex flex-col justify-start">
                <div class="flex flex-col lg:flex-row lg:gap-10 lg:items-center">
                    ...
                    <div class="mt-3">
                        <p class="text-sm leading-tight text-justify text-white lg:leading-normal lg:text-[1.1rem]">En La casa del Automóvil nos dedicamos a brindar soluciones
                            exclusivas
                ...
                <div class="my-6 flex justify-center">
                    <ul class="flex text-xl gap-3 lg:gap-10 lg:mt-4 lg:text-3xl">
                        <li class="flex justify-center items-center bg-gray-600 w-10 h-10 rounded-full group hover:bg-white lg:w-16 lg:h-16"><a
                                href="#"><i class="fa-brands fa-facebook-f text-white group-hover:text-red-600"></i></a></li>
                        <li class="flex justify-center items-center bg-gray-600 w-10 h-10 rounded-full group hover:bg-white lg:w-16 lg:h-16"><a
                                href="#"><i class="fa-brands fa-instagram text-white group-hover:text-red-600"></i></a></li>
                        <li class="flex justify-center items-center bg-gray-600 w-10 h-10 rounded-full group hover:bg-white lg:w-16 lg:h-16"><a
                                href="#"><i class="fa-brands fa-tiktok text-white group-hover:text-red-600"></i></a></li>
                        <li class="flex justify-center items-center bg-gray-600 w-10 h-10 rounded-full group hover:bg-white lg:w-16 lg:h-16"><a
                                href="#"><i class="fa-brands fa-youtube text-white group-hover:text-red-600"></i></a></li>
                        <li class="flex justify-center items-center bg-gray-600 w-10 h-10 rounded-full group hover:bg-white lg:w-16 lg:h-16"><a
                                href="#"><i class="fa-brands fa-whatsapp text-white group-hover:text-red-600"></i></a></li>
                    </ul>
                </div>
                <div class="pb-8">
                    ...
                    <div class="flex flex-col gap-1 text-white">
                        ...
                        <p class="text-lg"><i class="fa-solid fa-envelope-circle-check mx-3"></i>ventas@lacasadelautomovil.com</p>
                    </div>
                </div>
